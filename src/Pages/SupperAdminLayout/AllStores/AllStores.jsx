        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-slate-800/40 p-4 rounded-xl border border-slate-700/40">
          ...
          <div className="relative flex items-center bg-slate-950/50 border border-slate-700 rounded-lg px-3 py-2.5 text-sm text-slate-300">
            ...
            >
              ...
              <option value="Blocked" className="bg-slate-800">
                Blocked/Suspended
              </option>
            </select>
          </div>
                    ...
                    >
                      <td className="py-4 px-5">
                        ...
                        <div className="text-xs text-slate-500 font-mono mt-0.5">
                          {store.id} • Joined {store.joinedDate}
                        </div>
                      </td>
                      <td className="py-4 px-5">
                      ...
                      <td className="py-4 px-5">
                        <span
                          className={`px-2.5 py-0.5 rounded-full text-xs font-semibold tracking-wide ${statusStyles[store.status]}`}
                        >
                          {store.status}
                        </span>
                      </td>
                      <td className="py-4 px-5">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            className="p-1.5 bg-slate-700/50 hover:bg-slate-600 border border-slate-600 rounded text-slate-300 hover:text-white transition-colors"
                            title="View Store Shop"
                          >
                            <HiEye size={16} />
                          </button>
                          {store.status !== "Active" && (
                          ...
                          {store.status !== "Blocked" && (
                            <button
                              onClick={() =>
                                handleStatusChange(store.id, "Blocked")
                              }
