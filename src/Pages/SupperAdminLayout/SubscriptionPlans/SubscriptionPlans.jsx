...
const initialPlans = [
  {
    ...
    billing: "Monthly",
    activeVendors: 45,
    features: "50 Products, 1 Storefront, Standard Support",
    tier: "Starter",
  },
  {
    id: "PLN-2026-02",
    ...
    billing: "Monthly",
    activeVendors: 120,
    features: "Unlimited Products, 3 Storefronts, Premium Support",
    tier: "Pro",
  },
  {
    id: "PLN-2026-03",
    ...
    billing: "Yearly",
    activeVendors: 18,
    features: "White-label Domain, Dedicated DB, Custom Gateway",
    tier: "Enterprise",
  },
];
        ...
        <div className="bg-slate-800/50 backdrop-blur-md p-6 rounded-xl border border-slate-700/50 shadow-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold flex items-center gap-2.5">
              <HiCurrencyDollar className="text-indigo-400" /> Subscription
              Framework
            </h1>
            <p className="text-sm text-slate-400 mt-1">
              Configure SaaS pricing layers instantly within the active datagrid
              rows.
            </p>
          </div>
            ...
            <table className="w-full text-sm text-left border-collapse">
              <thead className="bg-slate-900/50 border-b border-slate-700/50 text-slate-400 uppercase text-[11px] font-bold tracking-wider">
                <tr>
                  ...
                  <th className="py-4 px-6 w-[23%]">
                    Core Guardrails & Features
                  </th>
              ...
              <tbody className="divide-y divide-slate-700/50 text-slate-300">
                {filteredPlans.length > 0 ? (
                      ...
                      >
                        ...
                        <td className="py-4 px-6 align-middle">
                          {isEditing ? (
                            ...
                            <span
                              className={`px-2.5 py-0.5 rounded-md text-xs font-semibold tracking-wide border ${
                                plan.billing === "Yearly"
                        ...
                        <td className="py-4 px-6 align-middle">
                          {isEditing ? (
                            ...
                            <div
                              className="text-sm text-slate-400 truncate max-w-[240px]"
                              title={plan.features}
                            >
                              {plan.features}
                            </div>
                  ...
                  <tr>
                    ...
                    >
                      No matching packages localized in active workspace
                      directory.
                    </td>
                  </tr>
                )}
        ...
        <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700/40 flex items-start gap-3 shadow-inner">
          ...
          <div className="text-xs text-slate-400 space-y-1">
            ...
            <p>
              ...
              ) keeps active focus without full-screen modal overlays.
            </p>
          </div>
        </div>
      </div>
