          ...
          {products.slice(0, 8).map((product) => {
            ...
            return (
              <Link to={`/product-list/`} key={product.id}>
                ...
                >
                  {/* ✅ HeroUI Card সরিয়ে সাধারণ div */}
                  <div className="w-full h-full flex flex-row items-center gap-4 bg-[#F8F9FA] hover:bg-white border border-neutral-200/40 hover:border-emerald-500/30 hover:shadow-[0_10px_25px_rgba(0,0,0,0.03)] rounded-[20px] p-4 relative transition-all duration-300 group cursor-pointer">
