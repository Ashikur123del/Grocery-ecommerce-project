    ...
    <section className="container mx-auto px-6 md:px-12 py-16 select-none bg-white">
      ...
      <div className="flex items-end justify-between mb-8">
        ...
        <div className="flex gap-2.5">
          <button
            ref={prevRef}
            className="w-9 h-9 flex items-center justify-center rounded-full border border-neutral-200 text-neutral-600 hover:bg-[#00A859] hover:text-white hover:border-[#00A859] transition-all duration-300 disabled:opacity-40"
          >
